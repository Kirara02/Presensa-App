...
extension StringExtensions on String? {
  ...
  String? get toCamelCase {
    ...
    List<String> separatedWords = this!.split(
      RegExp(r'[!@#<>?":`~;[\]\\|=+)(*&^%-\s_]+'),
    );
  ...
  String? get toStartCase {
    if (isBlank) return null;
    final separatedWords = this!.split(
      RegExp(r'[!@#<>?":`~;[\]\\|=+)(*&^%-\s_]+'),
    );
  ...
  String? get trimEndSpaces {
    return isNull ? null : this!.replaceAll(RegExp(r'\s+$'), '');
  }

  String toFormattedDateTimeLocal() => DateFormat(
    'dd MMM yyyy, hh:mm a',
