...
extension DateTimeExtensions on DateTime {
  ...
  DateTimeRange get sameDayRange =>
  ...
  DateTime get lastDayOfWeek => add(Duration(days: 7 - weekday)).endOfDay;

  DateTimeRange get sameWeekRange =>
  ...
  DateTimeRange get sameMonthRange =>
      DateTimeRange(start: firstDayOfMonth, end: lastDayOfMonth);

  // /////////////////////////////////////////////////////////////////////////////

  DateTime get firstDayOfFinYear => DateTime(month >= 4 ? year : year - 1, 4);

  DateTime get lastDayOfFinYear =>
      DateTime(month >= 4 ? year + 1 : year, 3, 31).endOfDay;

  DateTimeRange get sameFinYearRange =>
      DateTimeRange(start: firstDayOfFinYear, end: lastDayOfFinYear);
  ...
  String convertToDaysAgo(BuildContext context) {
    ...
    if (diff.inDays < 1) {
      ...
      return DateFormat.yMMMd(
        context.currentLocale.toLanguageTag(),
      ).format(this);
    }
  }
