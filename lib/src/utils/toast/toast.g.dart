...
class ToastFamily extends Family<Toast> {
  ...
  @override
  ToastProvider getProviderOverride(covariant ToastProvider provider) {
...
class ToastProvider extends AutoDisposeProvider<Toast> {
  /// See also [toast].
  ToastProvider(BuildContext context)
    : this._internal(
        (ref) => toast(ref as ToastRef, context),
        from: toastProvider,
  ...
  @override
  Override overrideWith(Toast Function(ToastRef provider) create) {
